...
global {
    ...
    string NombreArchivoResultado <- "Log_0209_d8020_Modelo2";
...
species Persona skills:[moving] {
	...
	reflex infectar when: estaInfectado = false and estaRecuperado = false and estaRecuperado = false{
		float sumarProb <- 0.0;
		...
		int cantPersonasRadio <- length(ListaPersonasRadio);
